...
from models.classification_utils import VectorClassifierHead
...
class Model(nn.Module):
    ...
    def _encode(self, x: torch.Tensor) -> torch.Tensor:
        ...
        elif x.dim() == 3 and x.shape[1] == self.seq_len and x.shape[2] == self.in_channels:
